...
ActiveRecord::Schema.define(version: 2019_11_27_195342) do
  ...
  create_table "replies", force: :cascade do |t|
    t.integer "piu_id", null: false
    t.string "content"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["piu_id"], name: "index_replies_on_piu_id"
  end
